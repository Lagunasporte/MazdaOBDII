...
extension String {
    /// Returns the localized string using the current bundle
    /// Note: For dynamic language changes, use LocalizationManager.shared.localizedString() directly in views
